package com.dolsoft.licensing_service.config;
...
import com.dolsoft.licensing_service.support.jpa.CustomRepositoryFactoryBean;
import com.dolsoft.licensing_service.support.jpa.SpringSecurityAuditorAware;
import com.dolsoft.licensing_service.web.entity.User;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.dolsoft.licensing_service.web.repository", repositoryFactoryBeanClass = CustomRepositoryFactoryBean.class)
// @EnableJpaRepositories(basePackages =
// "com.dolsoft.licensing_service.web.repository",
